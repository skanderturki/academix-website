      ...
      <div className="container-page relative py-16">
        <div className="mx-auto max-w-md">
          <div className="relative">
            <div
              className="absolute -inset-2 rounded-[28px] bg-gradient-to-r from-brand-navy/30 via-gold/20 to-brand-light/30 blur-2xl opacity-70"
              aria-hidden="true"
            />
            <div className="relative rounded-2xl border border-white/10 bg-card/60 backdrop-blur-xl p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <p className="text-center text-sm text-white/60">
                  ...
                  <a href="#register" className="text-gold hover:text-gold-light transition">
                    Register here
                  </a>
                </p>
              </form>
