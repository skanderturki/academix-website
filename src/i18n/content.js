...
export const content = {
  en: {
    ...
    faq: {
      eyebrow: 'Questions',
      title: 'ABET and Academix,',
      titleHighlight: 'briefly',
      more: 'All questions and answers',
      items: [
        ['What is ABET accreditation?', 'A review by ABET’s volunteer experts confirming that a university program meets the quality standards of its profession. ABET accredits programs in applied and natural science, computing, engineering and engineering technology: 4,863 programs at 950 institutions in 42 countries, according to abet.org.'],
        ['Why does it matter for a program?', 'Graduates of accredited programs are recognized by employers, licensing bodies and graduate schools, and ABET’s mutual recognition agreements (Washington, Sydney, Dublin and Seoul Accords) extend that recognition internationally.'],
        ['Which programs are eligible?', 'Programs under one of ABET’s four commissions (engineering, engineering technology, computing, applied and natural science) at a recognized degree-granting institution. For an initial review, the program must have had at least one graduate in the two academic years before the visit.'],
        ['What are the ABET criteria?', 'Eight General Criteria (Students, Program Educational Objectives, Student Outcomes, Continuous Improvement, Curriculum, Faculty, Facilities, Institutional Support), plus the Program Criteria of the program’s discipline.'],
        ['Which commissions does Academix support?', 'All four: EAC, CAC, ETAC and ANSAC, with the 2026–27 Program Criteria of every EAC, ETAC and CAC discipline built in word for word.'],
        ['How is Academix priced?', 'Per department, per year, for one to three years. Request a quote; we reply by email and you pay by invoice.'],
      ],
    },
    contact: {
    ...
    footer: {
      ...
      platformsHeading: 'Resources',
      getInTouch: 'Get in Touch',
      links: {
        pmp: 'PMP Platform',
        n8n: 'n8n Server',
        allServices: 'All Services',
        guide: 'What is ABET accreditation?',
        criteria: 'ABET Program Criteria',
        ssr: 'The ABET Self-Study Report',
  ...
  fr: {
    ...
    faq: {
      eyebrow: 'Questions',
      title: 'ABET et Academix,',
      titleHighlight: 'en bref',
      more: 'Toutes les questions et réponses',
      items: [
        ['Qu’est-ce que l’accréditation ABET ?', 'Une évaluation par les experts bénévoles d’ABET qui confirme qu’un programme universitaire répond aux standards de qualité de sa profession. ABET accrédite des programmes en sciences appliquées et naturelles, informatique, ingénierie et technologie de l’ingénierie : 4 863 programmes dans 950 établissements de 42 pays, selon abet.org.'],
        ['Pourquoi est-ce important pour un programme ?', 'Les diplômés de programmes accrédités sont reconnus par les employeurs, les organismes d’habilitation et les écoles doctorales, et les accords de reconnaissance mutuelle d’ABET (Washington, Sydney, Dublin, Séoul) étendent cette reconnaissance à l’international.'],
        ['Quels programmes sont éligibles ?', 'Les programmes relevant d’une des quatre commissions d’ABET (ingénierie, technologie de l’ingénierie, informatique, sciences appliquées et naturelles) dans un établissement habilité à délivrer des diplômes. Pour une première évaluation, le programme doit avoir eu au moins un diplômé dans les deux années précédant la visite.'],
        ['Quels sont les critères ABET ?', 'Huit critères généraux (Étudiants, Program Educational Objectives, Student Outcomes, Amélioration continue, Curriculum, Corps enseignant, Installations, Soutien institutionnel), plus les Program Criteria de la discipline du programme.'],
        ['Quelles commissions Academix prend-il en charge ?', 'Les quatre : EAC, CAC, ETAC et ANSAC, avec les Program Criteria 2026–27 de chaque discipline EAC, ETAC et CAC intégrés mot pour mot.'],
        ['Quel est le tarif d’Academix ?', 'Par département et par an, pour un à trois ans. Demandez un devis ; nous répondons par e-mail et vous réglez sur facture.'],
      ],
    },
    contact: {
    ...
    footer: {
      ...
      platformsHeading: 'Ressources',
      getInTouch: 'Nous contacter',
      links: {
        pmp: 'Plateforme PMP',
        n8n: 'Serveur n8n',
        allServices: 'Tous les services',
        guide: 'Qu’est-ce que l’accréditation ABET ?',
        criteria: 'Les Program Criteria ABET',
        ssr: 'Le Self-Study Report ABET',
